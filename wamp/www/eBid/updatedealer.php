		...
		if(file_exists("images/".$f['name']))
          {
           ...
           { 
			   ...
			   if(isset($_SESSION['dimage']))
			   {
				   unlink("images/".$_SESSION['dimage']);
			   }
	           move_uploaded_file($f['tmp_name'],"images/".$f['name']);
			   $q="update dealers set image='$fname' where name='$u'";
			   $update=mysqli_query($con,$q);
			   $_SESSION['dimage']=$f['name'];
...
border-radius: 50%;
    ...
    text-align: center;
	background-image:url('http://localhost/eBid/images/<?php if(isset($_SESSION['dimage'])){echo $_SESSION['dimage'];}else{echo "newuser.png";}?>');
...
<div class="header">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-15">
      <input type="text" class="form-control" id="email" value="<?php echo $_SESSION['dname'];?>">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-15"> 
      <input type="text" class="form-control" id="pwd" value="<?php echo $_SESSION['dmbn'];?>">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-3" for="pwd">Address:</label>
    <div class="col-sm-15"> 
      <input type="text" class="form-control" id="pwd" value="<?php echo $_SESSION['dadr'];?>">
    </div>
  </div>
  <div class="form-group">
